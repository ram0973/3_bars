...
Пример json-файла (обратите внимание, в координатах сначала идёт широта,
затем долгота:
...
Если нужно, изменить константу JSON_URL, в которой хранится URL файла с 
данными о барах, в файле bars.py
